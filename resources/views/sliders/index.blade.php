...
<style>
    ...
    .bricon
    {
        background: {!! Html::image('sliders/browser-icons.png') !!};
    }
</style>
...
<div id="slider2_container" style="position: relative; top: 0px; left: 0px; width: 1000px;
    ...
    <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1000px; height: 300px;
            overflow: hidden;">
        <div>
            <a u=image href={!! url('http://www.google.ie') !!}>{!! Html::image('sliders/01.jpg') !!}</a>

        </div>
        <div>
            <a u=image href="#">{!! Html::image('sliders/02.jpg') !!}</a>
        </div>
        <div>
            <a u=image href="#">{!! Html::image('sliders/03.jpg') !!}</a>
        </div>
        <div>
            <a u=image href="#">{!! Html::image('sliders/04.jpg') !!}</a>
        </div>
    </div>
    ...
    <div u="navigator" class="jssorb01" style="bottom: 20px; right: 10px;">
    ...
    <style>
        ...
        */
        .jssora05l, .jssora05r {
            ...
            height: 40px;
            cursor: pointer;
            background: {!! Html::image('sliders/a17.png') !!} no-repeat;
            overflow: hidden;
        }
